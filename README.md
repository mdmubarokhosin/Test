...
```
https://github.com/mdmubarokhosin/Ibadat365.git এটাকে ভালোভাবে পর্যবেক্ষণ করুন এবং কোথায় কি কি সমস্যা আছে সকল সমস্যা ঠিক করে দিন এবং এটার মধ্যে আর কি কি আপডেট করা যেতে পারে এখন কোথায় কি কি কনটেন্ট যুক্ত করা যেতে পারে সেগুলো যোগ করুন এবং আপডেট করুন এবং কম্প্লিট প্রোডাকশন রেডি apk বিল্ড করুন এবং  সকল অপ্রয়োজনিয় ফাইল বাদ দিয়ে  কম্প্লিট প্রোডাকশন রেডি source code + apk (ভবিষ্যতের জন্য যেন প্রভর্তিতে এডিট করতে পারি)  zip  file তৈরি করে দিন  and upload to gofile.io.io এবং গিটহাব রিপোজিটরিতে কোড পুশ করার নির্দেশনাবলী দিয়ে দিন।
